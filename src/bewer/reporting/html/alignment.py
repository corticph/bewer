...
def _get_key_term_indicators(
    alignment: "Alignment", allow_subset_matches: bool = False, only_local_matches: bool = False
    ...
    for vocab in vocabs:
        matches = example.ref.get_key_term_matches(
            vocab=vocab, allow_subset_matches=allow_subset_matches, only_local_matches=only_local_matches
        )
...
def generate_alignment_html_lines(
    ...
    start_indices, stop_indices, open_indices = _get_key_term_indicators(
        alignment, allow_subset_matches=allow_subset_matches, only_local_matches=only_local_matches
    )
