...
class AlphaNumP(Metric):
    ...
    description = (
        ...
        "pattern matches a candidate string when either: (a) it contains at least one uppercase letter and "
        "is not an ordinary capitalised compound (one or more parts that are each either init-cap or all "
