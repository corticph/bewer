...
class TestAlignmentInsertionRuns:
    """Tests for Alignment.insertion_runs and max_insertion_run_length."""

    def test_insertion_runs_empty(self):
        """Test insertion_runs with no insertions."""
        ops = [Op(type=OpType.MATCH, ref="a", hyp="a")]
        alignment = Alignment(ops, src=Mock())
        assert alignment.insertion_runs == []

    def test_max_insertion_run_length_empty(self):
        """Test max_insertion_run_length with no insertions."""
        ops = [Op(type=OpType.MATCH, ref="a", hyp="a")]
        alignment = Alignment(ops, src=Mock())
        assert alignment.max_insertion_run_length == 0

    def test_insertion_runs_single(self):
        """Test insertion_runs with a single insertion."""
        ops = [
            Op(type=OpType.MATCH, ref="a", hyp="a"),
            Op(type=OpType.INSERT, ref=None, hyp="b"),
            Op(type=OpType.MATCH, ref="c", hyp="c"),
        ...
        alignment = Alignment(ops, src=Mock())
        assert alignment.insertion_runs == [1]

    def test_insertion_runs_contiguous(self):
        """Test insertion_runs with a contiguous run of 3."""
        ops = [
            Op(type=OpType.MATCH, ref="a", hyp="a"),
            Op(type=OpType.INSERT, ref=None, hyp="b"),
            Op(type=OpType.INSERT, ref=None, hyp="c"),
        ...
        alignment = Alignment(ops, src=Mock())
        assert alignment.insertion_runs == [3]

    def test_insertion_runs_multiple(self):
        """Test insertion_runs with multiple separated runs."""
        ops = [
            Op(type=OpType.INSERT, ref=None, hyp="a"),
            Op(type=OpType.MATCH, ref="b", hyp="b"),
            Op(type=OpType.INSERT, ref=None, hyp="c"),
            Op(type=OpType.INSERT, ref=None, hyp="d"),
            Op(type=OpType.MATCH, ref="e", hyp="e"),
            Op(type=OpType.INSERT, ref=None, hyp="f"),
        ]
        alignment = Alignment(ops, src=Mock())
        assert alignment.insertion_runs == [1, 2, 1]

    def test_insertion_runs_all_insertions(self):
        """Test insertion_runs when all ops are insertions."""
        ops = [
            Op(type=OpType.INSERT, ref=None, hyp="a"),
            Op(type=OpType.INSERT, ref=None, hyp="b"),
        ]
        alignment = Alignment(ops, src=Mock())
        assert alignment.insertion_runs == [2]

    def test_insertion_runs_starts_with_insertion(self):
        """Test insertion_runs when alignment starts with insertions."""
        ops = [
            Op(type=OpType.INSERT, ref=None, hyp="a"),
            Op(type=OpType.INSERT, ref=None, hyp="b"),
            Op(type=OpType.MATCH, ref="c", hyp="c"),
    ...
    def test_insertion_runs_ends_with_insertion(self):
        """Test insertion_runs when alignment ends with insertions."""
        ops = [
            Op(type=OpType.MATCH, ref="a", hyp="a"),
            Op(type=OpType.INSERT, ref=None, hyp="b"),
            Op(type=OpType.INSERT, ref=None, hyp="c"),
    ...
    def test_max_insertion_run_length_single(self):
        """Test max_insertion_run_length with single insertion."""
        ops = [
            Op(type=OpType.MATCH, ref="a", hyp="a"),
            Op(type=OpType.INSERT, ref=None, hyp="b"),
        ]
        alignment = Alignment(ops, src=Mock())
        assert alignment.max_insertion_run_length == 1

    def test_max_insertion_run_length_contiguous(self):
        """Test max_insertion_run_length with contiguous run."""
        ops = [
            Op(type=OpType.MATCH, ref="a", hyp="a"),
            Op(type=OpType.INSERT, ref=None, hyp="b"),
            Op(type=OpType.INSERT, ref=None, hyp="c"),
        ...
        alignment = Alignment(ops, src=Mock())
        assert alignment.max_insertion_run_length == 3

    def test_max_insertion_run_length_all_insertions(self):
        """Test max_insertion_run_length when all ops are insertions."""
        ops = [
            Op(type=OpType.INSERT, ref=None, hyp="a"),
            Op(type=OpType.INSERT, ref=None, hyp="b"),
            Op(type=OpType.INSERT, ref=None, hyp="c"),
    ...
    def test_insertion_runs_empty_alignment(self):
        """Test insertion_runs on empty alignment."""
        alignment = Alignment(src=Mock())
        assert alignment.insertion_runs == []
        assert alignment.max_insertion_run_length == 0
